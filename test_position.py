    ...
    while Running:
        ...
        #             reward = -0.1
            ...
            if dist < 3 :
                ...
                rwd_dtsi = ((math.log(dist)-1)/math.log(dist))
            episode_reward += rwd_dtsi
        ...
        num += 1
        print(f"dist reward: {rwd_dtsi:.3f} total steps: {num}  Speed: {speed}",end="\r")
        state = next_state
        ...
        if car_world.done or episode_steps >= EPISODE_STEP_MAX:
            ...
            if episode_num% 50 == 0:
                agent.model.save("model_dist.h5")
